/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=server/wrangler.jsonc server/worker-configuration.d.ts` (hash: 6813d07d2279f425db04ed0055c1b744)
// Runtime types generated with workerd@1.20260826.1 2026-09-05 nodejs_compat
interface __BaseEnv_Env {
	ROOMS: DurableObjectNamespace<import("./index").RaceRoom>;
	QUEUES: DurableObjectNamespace<import("./index").MatchQueue>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "RaceRoom" | "MatchQueue";
	}
